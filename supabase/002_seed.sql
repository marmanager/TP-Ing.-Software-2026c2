...
insert into caso (id, negocio_id, numero, cliente_id, servicio, identificador, estado, responsable_id, que_falta, abierto_en) values
  ('00000000-0000-0000-0000-000000000248', '00000000-0000-0000-0000-0000000000b0', 248, '00000000-0000-0000-0000-0000000000c1', 'Revisión general', 'AB 123 CD',        'esperando',      '00000000-0000-0000-0000-0000000000e1', 'Espera respuesta del cliente',  now() - interval '4 days'),
  ('00000000-0000-0000-0000-000000000245', '00000000-0000-0000-0000-0000000000b0', 245, '00000000-0000-0000-0000-0000000000c2', 'Cambio de pieza', 'AC 456 EF',         'esperando',      null,                                   'El insumo llega mañana',        now() - interval '6 days'),
  ('00000000-0000-0000-0000-000000000251', '00000000-0000-0000-0000-0000000000b0', 251, '00000000-0000-0000-0000-0000000000c3', 'Diagnóstico', 'AD 789 GH',             'en_proceso',     '00000000-0000-0000-0000-0000000000e2', 'Diagnóstico a medio cargar',    now() - interval '1 day'),
  ('00000000-0000-0000-0000-000000000239', '00000000-0000-0000-0000-0000000000b0', 239, '00000000-0000-0000-0000-0000000000c4', 'Reparación', 'AA 321 BC',              'revision_final', '00000000-0000-0000-0000-0000000000e3', 'Control antes de entregar',     now() - interval '9 days'),
  ('00000000-0000-0000-0000-000000000249', '00000000-0000-0000-0000-0000000000b0', 249, '00000000-0000-0000-0000-0000000000c7', 'Service de 40.000 km', 'AE 654 JK',    'revision_final', '00000000-0000-0000-0000-0000000000e1', 'Control antes de entregar',     now() - interval '5 days'),
  ('00000000-0000-0000-0000-000000000252', '00000000-0000-0000-0000-0000000000b0', 252, '00000000-0000-0000-0000-0000000000c8', 'Frenos delanteros', 'AF 987 LM',       'en_proceso',     '00000000-0000-0000-0000-0000000000e2', 'Está en el taller',             now() - interval '2 days'),
  ('00000000-0000-0000-0000-000000000253', '00000000-0000-0000-0000-0000000000b0', 253, '00000000-0000-0000-0000-0000000000c5', 'Primera consulta', 'AG 147 NP',        'nuevo',          null,                                   'Asignar a alguien del equipo',  now() - interval '3 hours'),
  ('00000000-0000-0000-0000-000000000254', '00000000-0000-0000-0000-0000000000b0', 254, '00000000-0000-0000-0000-0000000000c9', 'Cambio de correa', 'AH 258 QR',        'nuevo',          null,                                   'Asignar a alguien del equipo',  now() - interval '1 hour'),
  ('00000000-0000-0000-0000-000000000255', '00000000-0000-0000-0000-0000000000b0', 255, '00000000-0000-0000-0000-0000000000ca', 'Alineación y balanceo', 'AI 369 ST',   'en_proceso',     '00000000-0000-0000-0000-0000000000e3', 'Está en el taller',             now() - interval '1 day'),
  ('00000000-0000-0000-0000-000000000232', '00000000-0000-0000-0000-0000000000b0', 232, '00000000-0000-0000-0000-0000000000c6', 'Mantenimiento', 'AJ 741 UV',           'completado',     null,                                   'Cobrado el viernes',            now() - interval '14 days');
